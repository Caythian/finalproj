...
function App() {
  ...
  return (
      ...
      <div className="textholder">
        ...
        <div className="floatingsubtitle">the art of immersive gaming, inspired by "Legend of Zelda: Tears of the Kingdom"</div>
      ...
      <div className="body">
        Welcome to our exploration of the art of immersive gaming, with a special focus on the acclaimed “Legend of Zelda: Tears of the Kingdom”.
      </div>  
      ...
      <div className="body"> At the core of immersive gaming is the delicate balance between realism and fantasy. It's about crafting a world that feels real enough to make you believe in your presence and impact, yet fantastical enough to remind you of the joy and wonder of gaming. We dissect the visual elements of game design that contribute to this equilibrium, using the popular "Legend of Zelda: Tears of the Kingdom" as our primary case study.
      </div>
