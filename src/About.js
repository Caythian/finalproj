...
function About(){
    ...
    return(
        ...
        <div className="subtitleimg" id="sub2">The Quest for Meaningful Gaming</div>
      </ImageSection>
        <div className="body">
        ...
        <div className="subtitleimg" id="sub3">A Case Study in Excellence - "Zelda: Tears of the Kingdom"</div>
        </ImageSection>
        <div className="body">
        ...
        <div className="subtitle" id="sub4">Beyond Entertainment</div>
        <div className="body">
        ...
        <div className="subtitle" id="sub5">Join Us in This Exploration</div>
        <div className="body">
